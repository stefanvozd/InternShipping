...
class ArticleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Article entity")
        ...
        .repeat(2) {
            ...
            .post("/api/articles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "image":null, "title":"SAMPLE_TEXT", "shortDescription":"SAMPLE_TEXT", "longDescription":"SAMPLE_TEXT", "creationDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
